...
ctld.crateWaitTime = 300 -- time in seconds to wait before you can spawn another crate -- Edited, default = 120

ctld.forceCrateToBeMoved = false -- a crate must be picked up at least once and moved before it can be unpacked. Helps to reduce crate spam -- Edited, default = true, this parameter must be set to false as DCS has a bug that will cause crate move detection fail
...
ctld.spawnableCrates = { -- Edited, define our own cargo types, note that cargo is referenced by its weight, so the weight must not be the same
    ...
    ["Ground Forces"] = {
        ...
        { weight = 1300, desc = "BRDM-2", unit = "BRDM-2", side = 2 },
        { weight = 1350, desc = "BMP-3", unit = "BMP-3", side = 2 },
        { weight = 1400, desc = "BTR-82A", unit = "BTR-82A", side = 2 },
        { weight = 1450, desc = "T-90", unit = "T-90", side = 2  },
    },
    ["AA Short Range"] = {
        { weight = 1100, desc = "Avenger", unit = "M1097 Avenger", side = 2 },
        { weight = 1150, desc = "2S6 Tunguska", unit = "2S6 Tunguska", side = 2 },
        { weight = 1200, desc = "Tor 9A331", unit = "Tor 9A331", side = 2 },
        { weight = 1250, desc = "M6 Linebacker", unit = "M6 Linebacker", side = 2 },
    },
    ["Support Vehicles"] = {
        { weight = 1000, desc = "HMMWV - MG", unit = "M1043 HMMWV Armament", side = 2 },
        { weight = 1050, desc = "Ural-375 Ammo Truck", unit = "Ural-375", side = 2 },
    },
}
