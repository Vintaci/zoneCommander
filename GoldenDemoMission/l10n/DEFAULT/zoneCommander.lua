...
do
	...
	function BattleCommander:increaseDifficulty()
		self.difficultyModifier = math.min(self.difficultyModifier + self.difficulty.escalation, self.difficulty.max) -- Edited, default = math.max(self.difficultyModifier-self.difficulty.escalation, self.difficulty.min)
	...
	function BattleCommander:decreaseDifficulty()
		self.difficultyModifier = math.max(self.difficultyModifier - self.difficulty.fade, self.difficulty.min) -- Edited, default = math.min(self.difficultyModifier+self.difficulty.fade, self.difficulty.max)
		GlobalSettings.setDifficultyScaling(self.difficulty.start + self.difficultyModifier,self.difficulty.coalition)
		self.lastDiffChange = timer.getAbsTime()
...
do
	...
	-- Edited, add more cargo types
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-65D*10 [4800lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-65H*10 [4570lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-65G*10 [6622lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-65E*10 [6292lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-65K*10 [7920lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-88C*10 [7920lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Vikhr*48 [5808lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-84A*8 [11651lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-84E*8 [11651lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AGM-154C*10 [10648lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Kh-25ML*10 [7920lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Kh-25MPU*10 [8140lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Kh-29T*10 [16720lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Kh-29L*10 [16434lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Kh-58U*10 [16060lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo S-24B*20 [10340lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo S-25OFM*10 [10890lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo S-25L*10 [11000b]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo TOW*30 [4125lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo M151 Hydra HE*80 [4752lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo M156 Hydra WP*80 [4752lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-9M*30 [7128lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-9P5*30 [5676lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-9X*30 [5676lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-7M*24 [14995lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-120B*24 [11193lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-120C*24 [10665lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-60M*30 [2904lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Magic2*30 [5676lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-27R*24 [13359lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-27ER*24 [18480lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-27T*24 [13359lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-27ET*24 [18480lb"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo R-77*24 [9240lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Super 530D*24 [6480lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo AIM-54C*18 [18335lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-10*6 [15340lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-12*16 [9680lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-16*10 [12408lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-31V/B*6 [12328lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-31V3B*6 [12949lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo GBU-38*10 [6028lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo CBU-87*10 [9460lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo CBU-97*10 [10362lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo CBU-103*10 [10142lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo CBU-105*10 [11022lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Mk-82*20 [10560lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Mk-82AIR*20 [11044lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Mk-82Snakeye*20 [11880lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Mk-83*10 [9834lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo Mk-84*8 [15735b]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo FAB-100*20 [4400lb"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo FAB-250*20 [11000lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo FAB-500*10 [11000lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo BetAB-500*10 [9460lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo BetAB-500ShP*10 [9328lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo KAB-500kr*10 [12320lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo RBK-250 PTAB-2.5M*20 [12012lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo RBK-500-255 PTAB-10-5*10 [9394lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo RBK-500 PTAB-1M*10 [9394lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo M117*16 [11968lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo KMGU-2 - 96 AO-2.5RT*10 [11440lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo KMGU-2 - 96 PTAB-2.5KO*10 [11440lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo MK20*20 [9768lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Ammo SAB-100*20 [11000lb]"] = true
	HercCargoDropSupply.allowedCargo["weapons.bombs.Squad 30 x Soldier [7950lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC M1043 HMMWV Armament Air [7023lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC M1043 HMMWV Armament Skid [6912lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ATGM M1045 HMMWV TOW Air [7183lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ATGM M1045 HMMWV TOW Skid [7073lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.AAA Vulcan M163 Air [21666lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.AAA Vulcan M163 Skid [21577lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC M1126 Stryker ICV [29542lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SPG M1128 Stryker MGS [33036lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ATGM M1134 Stryker [30337lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC LAV-25 Air [22520lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC LAV-25 Skid [22514lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.M1025 HMMWV Air [6160lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.M1025 HMMWV Skid [6050lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM Avenger M1097 Air [7200lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM Avenger M1097 Skid [7090lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC Cobra Air [10912lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC Cobra Skid [10802lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC M113 Air [21624lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC M113 Skid [21494lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Tanker M978 HEMTT [34000lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.HEMTT TFFT [34400lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV M2A2 Bradley [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV MCV-80 [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BMP-1 [23232lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BMP-2 [25168lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BMP-3 [32912lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ARV BRDM-2 Air [12320lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ARV BRDM-2 Skid [12210lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC BTR-80 Air [23936lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC BTR-80 Skid [23826lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM ROLAND ADS [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM ROLAND LN [34720b]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM SA-13 STRELA [21624lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.AAA ZSU-23-4 Shilka [32912lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM SA-19 Tunguska 2S6 [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport UAZ-469 Air [3747lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport UAZ-469 Skid [3630lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport URAL-375 [14815lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport M818 [16000lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport Tigr Air [15900lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Transport Tigr Skid [15730lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.AAA GEPARD [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM CHAPARRAL Air [21624lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM CHAPARRAL Skid [21516lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.SAM LINEBACKER [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV MARDER [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV TPZ FUCH [33440lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BMD-1 Air [18040lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BMD-1 Skid [17930lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BTR-D Air [18040lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.IFV BTR-D Skid [17930lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ART 2S9 NONA Air [19140lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ART 2S9 NONA Skid [19030lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.ART GVOZDIKA [34720lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC MTLB Air [26400lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC MTLB Skid [26290lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.Generic Crate [20000lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.EWR SBORKA Air [21624lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.EWR SBORKA Skid [21624lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC BTR-82A Air [24998lb]"] = true
    HercCargoDropSupply.allowedCargo["weapons.bombs.APC BTR-82A Skid [24888lb]"] = true
	-- Edited done
